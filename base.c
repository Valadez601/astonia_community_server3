...
void special_potion(int in, int cn) {
    ...
    case 12:
        if (areaID != 33) ch[cn].hp = min(ch[cn].value[0][V_HP] * POWERSCALE, ch[cn].hp + 3 * POWERSCALE);
    ...
    case 13:
        if (areaID != 33) ch[cn].hp = min(ch[cn].value[0][V_HP] * POWERSCALE, ch[cn].hp + 4 * POWERSCALE);
    ...
    case 14:
        if (areaID != 33) ch[cn].hp = min(ch[cn].value[0][V_HP] * POWERSCALE, ch[cn].hp + 5 * POWERSCALE);
