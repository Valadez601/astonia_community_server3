...
void generate_sewer_mission(int lvl, struct military_ppd *ppd) { //9...39 step 2
    switch (RANDOM(5)) {
    case 0:
...
void military_master_driver(int cn, int ret, int lastact) {
    ...
    case 0:
        if (create_storage(dat->storage_ID, "Master Data", &dat->storage_data, sizeof(dat->storage_data))) dat->storage_state++;
        break;
    case 1:
        if (check_create_storage()) dat->storage_state++;
        break;
    case 2:
        if (read_storage(dat->storage_ID, dat->storage_version)) dat->storage_state++;
        break;
    case 3:
...
static void adv_introduction(int cn, int co, struct military_advisor_data *dat) {
    ...
    case 0:
        ptr = "I could do you a \260c4favor\260c0, %s, I could mention your name to the military governor of Aston. I'm sure that'd help you get that promotion early!";
        break;
    case 1:
        ptr = "Say, %s, would you like to speed up your way up the rank ladder? I could speak to the military governor of Aston if you want me to do you that \260c4favor\260c0.";
        break;
    case 2:
        ptr = "Not getting promoted as fast as you want, %s? I could do you the \260c4favor\260c0 of talking to the military governor of Aston about you.";
        break;
    default:
        ptr = "Need a \260c4favor\260c0, %s?";
        break;
    }
...
static void adv_favor_desc(int cn, int co, struct military_advisor_data *dat) {
    ...
    case 0:
        ptr = "My favors come in five sizes, \260c4small\260c0, \260c4medium\260c0, \260c4big\260c0, \260c4huge\260c0 and \260c4vast\260c0.";
        break;
    default:
        ptr = "I could do you a \260c4small\260c0, \260c4medium\260c0, \260c4big\260c0, \260c4huge\260c0 or \260c4vast\260c0 favor, %s.";
        break;
    }
...
void military_advisor_driver(int cn, int ret, int lastact) {
    ...
    for (msg = ch[cn].msg; msg; msg = next) {
        ...
        if (msg->type == NT_TEXT) {
            ...
            case 2:
                ...
                break;
            case 3:
                if (ppd->advisor_last[idx] == yday + 1) quiet_say(cn, "Mentioning your name twice a day won't accomplish much, %s.", ch[co].name);
    ...
    switch (dat->storage_state) {
    case 0:
        if (create_storage(dat->storage_ID, "Advisor Data", dat->storage_data, sizeof(dat->storage_data))) dat->storage_state++;
        break;
    case 1:
        if (check_create_storage()) dat->storage_state++;
        break;
