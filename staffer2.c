        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    quiet_say(cn, "I can offer 1,000 gold units for 5,000 silver units.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 13:
                    quiet_say(cn, "Or, I can offer 4,000 silver units for 1,000 gold units.");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 14:
                    quiet_say(cn, "Which wouldst thou like to trade? \260c4thousand gold\260c0 for 4000 silver or \260c4five thousand silver\260c0 for 1000 gold?");
                    ppd->broklin_state++;
                    didsay = 1;
                    break;
                case 15:
