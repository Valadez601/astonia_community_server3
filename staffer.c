        ...
        if (msg->type == NT_CHAR) {
            ...
            if (ppd) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    quiet_say(cn, "It was in the armory where the guards first started acting strangely and attacking everyone.");
                    ppd->rouven_state++;
                    didsay = 1;
                    break;
                case 3:
                ...
                case 10:
                    ...
                    break;
                case 11:
                    quiet_say(cn, "Now we get to the magical ritual. It was kept within the treasury behind me in the emperor's personal vault.");
                    ppd->rouven_state++;
                    didsay = 1;
                    break;
                case 12:
