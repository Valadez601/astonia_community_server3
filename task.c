...
int process_task(unsigned char *taskdata) {
    ...
    case 0:
        ...
        break;
    case 1:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *, int *, int *))set_clan_rank);
        break;
    case 2:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *, int *, int *))fire_from_clan);
        break;
    case 3:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *, int *, int *))punish_player);
        break;
    case 4:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *, int *, int *))unpunish_player);
        break;
    case 5:
        del = set_task((void *)(taskdata), (int (*)(void *, struct character *, int *, int *))set_flags);
        break;
